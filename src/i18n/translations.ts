...
export const TRANSLATIONS: Record<LanguageCode, Translations> = {
  ...
  am: {
    ...
    newChat: 'አዲስ ወሬ',
    newCall: 'አዲስ ጥሪ',
    noMessagesYet: 'እስካሁን ምንም መልእክት የለም። ውይይት ጀምር!',
  ...
  bn: {
    ...
    newChat: 'নতুন চ্যাট',
    newCall: 'নতুন কল',
    noMessagesYet: 'এখনও কোনো বার্তা নেই। একটি কথোপকথন শুরু করুন!',
